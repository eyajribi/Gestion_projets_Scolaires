...
class DeliverablesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (taskId == null) {
            // Si pas de task ID, essayer de récupérer les anciens extras pour compatibilité
            val livrableId = intent.getStringExtra(EXTRA_LIVRABLE_ID)
            ...
            // TODO: Récupérer les détails de la tâche depuis l'API
            binding.taskTitleDeliverableText.text = "Tâche"
            binding.projectNameDeliverableText.text = "Projet"
        }
    ...
    private fun setLoading(isLoading: Boolean) {
        ...
        binding.uploadButton.isEnabled = !isLoading && selectedFileUri != null
